...
console.log(onlyLetters("ciao 4 a tutti"));
/* ESERCIZIO 6
...
function addClass() {
  let addC = document.querySelector("tr");
  addC.classList.add(".test");
}
addClass();
// [EXTRA] JS Avanzato
...
*/
let searchByTitle = movies.find((element) => {
  return typeof element.a === "Lord";
});
